...
target 'Runner' do
  ...
  # Add Firebase pods manually if needed
  pod 'Firebase/Core'
  pod 'Firebase/Auth'
...
post_install do |installer|
  installer.pods_project.targets.each do |target|
    ...
    # Start of the permission-handler configuration
    target.build_configurations.each do |config|
      ...
      # This may help resolve FFmpeg conflicts or issues with Swift libraries
